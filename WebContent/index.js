require(['knockout', 'director','css!index.css'], function(ko) {
	$.ajaxSetup({
		cache:false
	});
    ...
    $(function() {
        $('#menu,#nav-zone').find("a[href*='#']").each(function(e) {
            ...
            console.log(path);
            //console.log(path);
           // if(path == "proDetail/proDetail"){
            //	 var href=path + '?pkBilltype=:pkBilltype&checkman=:checkman&billid=:billid&mobilebilltype=:mobilebilltype&workflow_type=:workflow_type&billtypename=:billtypename';
            //	 addRouter(href);
           // }else{
            	addRouter(path);
           //}
