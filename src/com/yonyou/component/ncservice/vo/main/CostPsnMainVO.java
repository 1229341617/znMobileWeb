...
public class CostPsnMainVO {
	...
	private CostPsnSubItem costpsnsub;// 子表信息list
	
	public CostPsnMainVO () {
		
	}

	public CostPsnSubItem getCostpsnsub() {
		return costpsnsub;
	}

	public void setCostpsnsub(CostPsnSubItem costpsnsub) {
		this.costpsnsub = costpsnsub;
	}
