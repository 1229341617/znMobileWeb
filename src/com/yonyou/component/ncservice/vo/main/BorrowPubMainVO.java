...
public class BorrowPubMainVO {
	...
	private BorrowPubSubItem brrowPubsub;// 子表信息list
	
	public BorrowPubMainVO(){
		
	}

	public BorrowPubSubItem getBrrowPubsub() {
		return brrowPubsub;
	}

	public void setBrrowPubsub(BorrowPubSubItem brrowPubsub) {
		this.brrowPubsub = brrowPubsub;
	}
