...
public class ComputerMainVO {
	...
	private ComputerSubItem  computersub;// 子表信息list
	
	public ComputerMainVO(){
		
	}

	public ComputerSubItem getComputersub() {
		return computersub;
	}

	public void setComputersub(ComputerSubItem computersub) {
		this.computersub = computersub;
	}
